...
class ValidationConfig:
    ...
    comprehension_model: str = "anthropic/claude-opus-4.7"
    comprehension_effort: str = "high"
    synthesis_model: str = "anthropic/claude-opus-4.7"
    improvement_model: str = "anthropic/claude-opus-4.7"
    ...
    report_model: str = "anthropic/claude-opus-4.7"
    methodology_version: str = "0.1.0"
